				...
				<!-- MAIN MENU -->
  				<nav class="wsmenu clearfix">
					<ul class="wsmenu-list nav-theme">
					    ...
					    <li class="nl-simple" aria-haspopup="true"><a href="#about-us" class="h-link">About</a></li>
					    
				    	<li class="nl-simple" aria-haspopup="true"><a href="./#features" class="h-link">Our Services</a></li>

				    	<li class="nl-simple" aria-haspopup="true"><a href="./#projects" class="h-link">Our Works</a></li>
					    ...
					    <li class="nl-simple" aria-haspopup="true">
					    	<a href="contact-us.php" class="btn r-04 btn--theme hover--theme last-link">Free Consultation</a>
					    </li> 
